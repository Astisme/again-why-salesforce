...
import { bg_getCurrentBrowserTab, bg_notify, checkLaunchExport, checkForUpdates } from "/background/utils.js";
...
Deno.test("bg_getCurrentBrowserTab behavior", async (t) => {
  ...
  BROWSER.tabs.setMockBrowserTabs([{ id: 0, url: "https://mock0.url", active: true, currentWindow: true }, { id: 1, url: "https://mock1.url", active: false, currentWindow: true }]);
