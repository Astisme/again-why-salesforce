...
- `review-sponsor.js` defines the custom element, decides whether review and sponsor links should be shown, and opens the correct browser-specific review destination or shared sponsor destination.
