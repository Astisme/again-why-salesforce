 ...
 * @param {string|null} [translatorLanguage=null] - the language code used to choose sponsor locale
 */
 ...
 * @param {TranslationService|null} [param0.translator=null] - backward-compatible translator instance
	...
	async _showReviewOrSponsor(result) {
		const [reviewMsg, sponsorMsg, allTabs, usageDays, translatorLanguage] =
			await Promise.all([
				...
				getTranslatorAttribute("currentLanguage"),
			]);
