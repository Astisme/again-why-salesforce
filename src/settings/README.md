...
This page is loaded from `options_ui.page` in [`src/manifest/template-manifest.json`](../manifest/template-manifest.json), and the popup also opens it through `openSettingsPage` in [`src/core/functions.js`](../functions.js).
