...
export const SALESFORCE_ID_PATTERN = new RegExp(
	String
		.raw`(?:^|\/|=)((?:${SALESFORCE_ID_PREFIX})[0-9a-zA-Z]{12,15})(?=$|\/|\?|&)`,
	"i",
);
...
// add `/lightning/setup/*` to the framePatterns
export const CONTEXT_MENU_PATTERNS = FRAME_PATTERNS.map((item) =>
	`${item.slice(0, -2)}${SETUP_LIGHTNING}*`
);
...
export const ANALYTICS_CDN_HOST = "simpleanalyticscdn.com";
export const ANALYTICS_QUEUE_SUBDOMAIN = "queue";
export const ANALYTICS_BEACON_PATH = "/noscript.gif";
export const ANALYTICS_EXTENSION_HOSTNAME = "extension.again.whysalesforce";
export const ANALYTICS_QUERY_PARAM_HOSTNAME = "hostname";
export const ANALYTICS_QUERY_PARAM_PATH = "path";
export const ANALYTICS_QUERY_PARAM_UTM_SOURCE = "utm_source";
export const ANALYTICS_QUERY_PARAM_EVENT_NAME = "eventName";
export const ANALYTICS_QUERY_PARAM_EVENT_TYPE = "eventType";
export const ANALYTICS_EVENT_NAME_NEW_USER = "new-user";
export const ANALYTICS_EVENT_NAME_RETURNING_USER = "returning-user";
export const ANALYTICS_EVENT_TYPE_INSTALL = "install";
export const ANALYTICS_EVENT_TYPE_USAGE = "usage";
export const ANALYTICS_EVENT_PATH_NEW_USER = "/new-user";
export const ANALYTICS_EVENT_PATH_RETURNING_USER = "/";
export const DATA_COLLECTION_TECHNICAL_AND_INTERACTION =
...
export const TUTORIAL_EVENT_CLOSE_MANAGE_TABS = "tutorial:manageTabs:closed";
