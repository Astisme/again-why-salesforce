...
cd src
zip -r "../bin/$ZIP_NAME" _locales action assets/icons assets/svgs background/bundledBackground.js components salesforce/bundledContent.js salesforce/lightning-navigation.js salesforce/css settings core manifest.json -x "*/README.md" >/dev/null 2>&1
cd ..
